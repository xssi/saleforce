    ...
    <div class="main_header">
        ...
        <el-row>
            ...
            <div class="left_image">
                <img src="https://ap15.salesforce.com/img/icon/t4v35/standard/lead_120.png" />
            </div>
            <div class="left_title">
                ...
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item @click.native="searchTableData">今天的潜在客户</el-dropdown-item>
                    <el-dropdown-item @click.native="searchTableData">全部未处理潜在客户</el-dropdown-item>
                    <el-dropdown-item @click.native="searchTableData">最近查看(固定列表)</el-dropdown-item>
                    <el-dropdown-item @click.native="searchTableData">最近已查看潜在客户</el-dropdown-item>
                </el-dropdown-menu>
                </el-dropdown>
            </div>
        ...
        <el-row>
            ...
            <div>7个项目</div>
            <div>•</div>
            <div>按名称排序 • 按 全部潜在客户 - 潜在客户状态 筛选 • 已在几秒前更新</div>
            </el-col>
            <!-- 搜索框 -->
            <el-col :xs="6" :sm="6" :md="6" :lg="6" :xl="6">
        ...
        <el-row class="dropdown">
            <el-table ref="multipleTable" class="tb-edit" highlight-current-row :data="tableData" style="width: 100%">
                ...
                <template v-for="(col ,index) in cols">      
                    <el-table-column v-if="col.type==='normal'" :prop="col.prop" sortable :label="col.label"  align="center" width="150"></el-table-column>
        ...
        <el-form :model="form">
            ...
            <p class="dialogTitle">潜在客户信息</p>
            <el-row>
                <el-col :span="11"><div class="grid-content bg-purple">
                    <el-form-item label="潜在客户状态" :label-width="formLabelWidth">                      
                ...
                <el-col :span="11" :offset="1"><div class="grid-content bg-purple-light">
                    <el-form-item label="潜在客户所有人" :label-width="formLabelWidth">
                        <el-input autocomplete="off"></el-input>
                    </el-form-item>
                </div></el-col>
            </el-row>
            <el-row>
                <p class="dialogSecTitle">名称</p>
                <el-col :span="11"><div class="grid-content bg-purple">
            ...
            <el-row>
                <el-col :span="11"><div class="grid-content bg-purple">
                    <el-form-item  :offset="2" label="名" :label-width="formLabelWidth">
                        <el-input autocomplete="off"></el-input>
                    </el-form-item>
                </div></el-col>
            </el-row>
            ...
            <el-row>
                ...
                <el-col :span="11" :offset="1"><div class="grid-content bg-purple-light">
                    <el-form-item label="职员数" :label-width="formLabelWidth">
                        <el-input autocomplete="off"></el-input>
                        </el-form-item>
                </div></el-col>
            </el-row>
            ...
            <el-col :span="24"><div class="grid-content bg-purple">
                <p class="dialogSecTitle">地址</p>
                <el-row>
                <el-col :span="22"><div class="grid-content bg-purple">
                    <p></p>
                    <el-form-item label="国家/地区" :label-width="formLabelWidth1">
                        <el-input autocomplete="off"></el-input>
                    </el-form-item>
                </div></el-col>
                <el-col :span="22"><div class="grid-content bg-purple-light">
                    <el-form-item label="州/省" :label-width="formLabelWidth1">
                    <el-input autocomplete="off"></el-input>
                    </el-form-item>
                </div></el-col>
                </el-row>
                ...
                <el-col :span="22"><div class="grid-content bg-purple-dark">
                    <el-form-item label="城市" :label-width="formLabelWidth1">
                        <el-input autocomplete="off"></el-input>
                    </el-form-item>
                </div></el-col>
                </el-row>
                <el-row>
                <el-col :span="22"><div class="grid-content bg-purple-dark">
                    <el-form-item label="街道" :label-width="formLabelWidth1">
                ...
                <el-row>
                <el-col :span="22"><div class="grid-content bg-purple-dark">
                    <el-form-item label="邮政编号" :label-width="formLabelWidth1">
                        <el-input autocomplete="off"></el-input>
                    </el-form-item>
                </div></el-col>
                </el-row>
        ...
        <!-- 删除dialog  -->
        <el-dialog title="删除潜在客户" :visible.sync="dialogFormVisible1">
            <p>是否确定要删除此潜在客户？</p>
            <div slot="footer" class="dialog-footer">
        ...
        <!-- 更改所有人dialog  -->
        <el-dialog title="更改潜在客户所有人" :visible.sync="dialogFormVisible2">
        <el-form :model="form">
            <el-form-item>
...
data() {
    return {
        ...
        cols: [
            { label: "名称", prop: "FULLNAME", type: "normal" },
            { label: "职务", prop: "TITLE", type: "normal" },
            { label: "公司", prop: "COMPANY", type: "normal" },
            { label: "电话", prop: "telephone", type: "normal" },
            { label: "手机", prop: "PHONE", type: "normal" },
            { label: "电子邮件", prop: "EMAIL", type: "normal" },
            { label: "潜在客户状态", prop: "STATUS", type: "normal" },
        ...
        allCols: [
            ...
            { label: "称谓", prop: "SALUTATION", type: "normal" },
            { label: "分级", prop: "RATING", type: "normal" },
            { label: "潜在客户来源", prop: "LEAD_SOURCE", type: "normal" },
            { label: "手机", prop: "MOBILE", type: "normal" },
            { label: "网址", prop: "WEBSITE", type: "normal" },
            { label: "行业", prop: "INDUSTRY", type: "normal" },
            { label: "职员数", prop: "EMPLOYEES", type: "normal" },
            { label: "州/省", prop: "PROVINCE", type: "normal" },
            { label: "街道", prop: "STREET", type: "normal" },
            { label: "邮政编码", prop: "POSTCODE", type: "normal" },
            { label: "上次修改时间", prop: "OPERATE_TIME", type: "normal" },
